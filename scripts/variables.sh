...
export CFLAGS="-mcpu=cortex-a35+crc+crypto --param l1-cache-size=32 --param l1-cache-line-size=64 --param l2-cache-size=256 -O3 -fomit-frame-pointer -fno-semantic-interposition -fipa-pta -fno-plt -flto=auto -ffat-lto-objects -fdevirtualize-at-ltrans $DISABLE_HARDENING_CFLAGS"
